  ...
  <div class="container mx-auto py-8 px-4 md:py-28 md:px-6 flex-grow relative">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="relative z-10">
        <img src="/public/trening1.png" alt="Training" class="w-full h-auto md:ml-14 md:w-10/12 lg:w-62 xl:w-68 2xl:w-144" style="max-width: 100%;">
      </div>
      <div class="relative z-10 md:mt-4">
        <p class="text-white font-bold text-4xl md:text-5xl md:leading-snug md:mb-8">Тренинг по развитию <br> Soft-skills</p>
...
@media (min-width: 768px) {
  .md\:ml-14 {
    margin-left: 3.5rem; /* Adjust as needed */
  }
}
</style>
